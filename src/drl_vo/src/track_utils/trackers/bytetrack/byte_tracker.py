...
from ...ultralytics.ultralytics.utils.ops import xywh2xyxy, xyxy2xywh
...
class BYTETracker(object):
    def __init__(self, track_thresh=0.45, match_thresh=0.8, track_buffer=25, frame_rate=30): # 0.45 0.8
