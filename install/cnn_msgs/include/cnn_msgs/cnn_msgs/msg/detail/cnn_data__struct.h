...
{
  /// pedestrian's position costmap in Cartesian coordinate: 2 channel, 20m * 20m, 80 x 80 grid
  rosidl_runtime_c__float__Sequence ped_pos_map;
  /// 240 range data from the laser scan
  rosidl_runtime_c__float__Sequence scan;
  /// 450 range data from the laser scan
  rosidl_runtime_c__float__Sequence scan_all;
  /// image data from the intel realsense camera
  rosidl_runtime_c__float__Sequence image_gray;
  /// depth image data from the intel realsense camera
