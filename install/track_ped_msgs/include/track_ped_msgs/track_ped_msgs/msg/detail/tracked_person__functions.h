...
#ifndef TRACK_PED_MSGS__MSG__DETAIL__TRACKED_PERSON__FUNCTIONS_H_
#define TRACK_PED_MSGS__MSG__DETAIL__TRACKED_PERSON__FUNCTIONS_H_
 ...
 * calls
 * track_ped_msgs__msg__TrackedPerson__init().
...
/**
 * It calls
 * track_ped_msgs__msg__TrackedPerson__fini()
 ...
 * track_ped_msgs__msg__TrackedPerson__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * track_ped_msgs__msg__TrackedPerson__Sequence__fini()
 * on the array,
...
#endif  // TRACK_PED_MSGS__MSG__DETAIL__TRACKED_PERSON__FUNCTIONS_H_
