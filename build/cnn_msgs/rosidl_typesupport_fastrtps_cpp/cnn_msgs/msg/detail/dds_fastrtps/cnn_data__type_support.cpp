...
#include "cnn_msgs/msg/detail/cnn_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: scan_all
  {
    cdr << ros_message.scan_all;
  }
  // Member: image_gray
  {
    cdr << ros_message.image_gray;
  }
  // Member: depth
  {
  ...
  // Member: goal_cart
  {
    cdr << ros_message.goal_cart;
  }
  // Member: goal_final_polar
  {
    cdr << ros_message.goal_final_polar;
  }
  // Member: vel
  {
    cdr << ros_message.vel;
  ...
  size_t current_alignment)
{
  ...
  // Member: ped_pos_map
  {
    ...
    size_t item_size = sizeof(ros_message.ped_pos_map[0]);
  ...
  // Member: scan
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.scan[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: scan_all
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.scan_all[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: image_gray
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.image_gray[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: depth
  ...
  // Member: goal_cart
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.goal_cart[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: goal_final_polar
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.goal_final_polar[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: vel
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cnn_msgs::msg::CnnData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cnn_msgs::msg::CnnData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cnn_msgs::msg::CnnData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CnnData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cnn_msgs::msg::CnnData *>(
...
static size_t _CnnData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CnnData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CnnData__callbacks = {
  "cnn_msgs::msg",
  "CnnData",
...
static rosidl_message_type_support_t _CnnData__handle = {
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cnn_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<cnn_msgs::msg::CnnData>()
{
  return &cnn_msgs::msg::typesupport_fastrtps_cpp::_CnnData__handle;
}
