...
static const _CnnData_type_support_symbol_names_t _CnnData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cnn_msgs, msg, CnnData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cnn_msgs, msg, CnnData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cnn_msgs, msg, CnnData)() {
  return &::cnn_msgs::msg::rosidl_typesupport_c::CnnData_message_type_support_handle;
}
